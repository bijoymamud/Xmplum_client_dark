    ...
    <div className="flex min-h-screen justify-center items-center">
      ...
      <div className="w-full md:w-1/2 dark:bg-[#181636]  min-h-screen flex flex-col justify-center items-center p-6 md:p-10">
        ...
        <form className="w-full max-w-md space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className="w-full dark:bg-[#04021C] bg-white font-medium  hover:bg-gray-200 hover:dark:bg-gray-900 border border-[#3831A3]  p-3 rounded-md mt-3 dark:text-[#E2E0F5] text-gray-900 "
          >
            Register
          </button>
        </form>
