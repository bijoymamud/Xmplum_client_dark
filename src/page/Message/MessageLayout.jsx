...
//   const [selectedBot, setSelectedBot] = useState('law'); // Default selected bot
...
//       {/* Sidebar */}
//       <div className={`${isSidebarCollapsed ? 'w-24' : 'w-80'} bg-white dark:bg-[#131221] border-r-2 dark:border-[#656092] border-gray-200 dark:text-[#D0CDEF] text-gray-800 flex flex-col`}>
...
//                       <div className="text-xs text-gray-500 dark:text-gray-400">{selectedBotData?.description}</div>
//                     </div>
//                   )}
//                 </div>
//                 <ChevronDown 
...
//                           selectedBot === bot.id ? 'bg-gray-100 dark:bg-gray-800 text-blue-600 dark:text-blue-400' : ''
//                         }`}
//                         onClick={() => {
...
//                             <div className="text-xs text-gray-500 dark:text-gray-400">{bot.description}</div>
//                           </div>
//                         )}
//                       </button>
//                     );
...
//           <h1 className="text-xl font-semibold dark:text-[#D0CDEF] text-gray-800">Messages</h1>
...
//                 <button className="w-full flex items-center gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600  dark:text-red-600 text-red-600 transition-colors duration-200">
//                   <LogOut size={16} />
//                   <span>Logout</span>
//                 </button>
...
import React, { useState } from "react";
import { Outlet, useNavigate } from "react-router-dom"; // Added useNavigate for redirection
import { 
  Menu,
  Plus,
  Settings,
...
const MessageLayout = () => {
  ...
  const handleLogoutConfirm = () => {
    // Simulate logout (e.g., clear token, redirect to login)
    console.log("Logging out...");
    // Replace with your logout logic (e.g., clear localStorage, redirect)
